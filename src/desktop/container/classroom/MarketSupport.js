...
import MarketSupportComponent from '../../components/classroom/MarketSupport';
import style from '../../styles/classroom.css';

const { Content } = Layout;

class MarketSupport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // 面包屑数据
